...
function getIdentity(source)
  ...
  TriggerEvent('es:addCommand', 'dark', function(source, args, user)
  	TriggerClientEvent('chatMessage', -1, "DarkWeb | " .. GetPlayerName(source), {255, 0, 0}, table.concat(args, " "))
  end, {help = 'DarkWeb :).'})

RegisterCommand('add', function(source, args)
  	TriggerClientEvent('chatMessage', -1, "^1[OGLOSZENIE]: " .. GetPlayerName(source), {255,215,0}, table.concat(args, " "))
  end, false)
