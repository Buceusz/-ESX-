      ...
      Item  = {
        {
          ...
          time   = 500,
          remove = 1,
          max    = 52, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
          price  = 35,
          requires = "iron",
      ...
      Item  = {
        {
          ...
          time   = 500,
          remove = 1,
          max    = 36, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
          price  = 70,
          requires = "gold",
