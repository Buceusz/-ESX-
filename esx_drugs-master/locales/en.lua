Locales['en'] = {
	...
	['press_sell_coke'] = 'press ~INPUT_CONTEXT~ to sell coke',
		['press_collect_ekstaza'] = 'press ~INPUT_CONTEXT~ to collect coke',
		['press_process_ekstaza'] = 'press ~INPUT_CONTEXT~ to process coke',
		['press_sell_ekstaza'] = 'press ~INPUT_CONTEXT~ to sell coke',
	...
	['act_imp_police'] = 'you cannot participate illegal activities unless there\'s enough cops online (~o~%s~s~/~y~%s~s~ online)',
		['inv_full_ekstaza'] = 'you can no longer collect Cocaine, your inventory is ~r~full~s~',
	...
	['not_enough_coke'] = 'you do not have enough coca leaf to ~r~pack~s~',
		['not_enough_ekstaza'] = 'you do not have enough coca leaf to ~r~pack~s~',
	['packing_in_prog'] = '~y~Packaging in progress~s~...',
	['no_pouchs_sale'] = 'You have no more pouches for ~r~sale~s~',
		['sold_one_ekstaza'] = 'you\'ve sold ~g~x1 Coke Pouch~s~',
