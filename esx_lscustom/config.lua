...
Config.Menus = {
	...
	cosmetics = {
		...
		wheels = _U('wheels'),
		modPlateHolder   	= 'Płyta - kontur',
		modVanityPlate   	= 'Płyta - przód',
		modTrimA    		= 'Wnętrze',
		modOrnaments    	= 'Ornaments',
		modDashboard    	= 'Pulpit nawigacyjny',
		modDial    			= 'Prędkościomierz',
		modDoorSpeaker    	= 'Dźwięk w drzwiach',
		modSeats    		= 'Gniazdo',
		modSteeringWheel    = 'Latający',
		modShifterLeavers   = 'Dźwignia zmiany biegów',
		modAPlate    		= 'Tylna plaża',
		modSpeakers    		= 'Dźwięk',
		modTrunk    		= 'Tułów',
		modHydrolic    		= 'Hydraulika',
		modEngineBlock    	= 'Blok silnika',
		modAirFilter    	= 'Filtr powietrza',
		modStruts    		= 'Rozpórki',
		modArchCover    	= 'Kołpaki',
		modAerials    		= 'Anteny',
		modTrimB    		= 'Ailes',
		modTank    			= 'Zbiornik',
		modWindows    		= 'Okno',
