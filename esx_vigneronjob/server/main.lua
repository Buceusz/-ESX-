...
AddEventHandler('esx_vigneronjob:startHarvest', function(zone)
	...
	if PlayersHarvesting[_source] == false then
		TriggerClientEvent('esx:showNotification', _source, '~r~Nie jest dobrze usterka ~w~')
...
AddEventHandler('esx_vigneronjob:stopHarvest', function()
	...
	if PlayersHarvesting[_source] == true then
		PlayersHarvesting[_source]=false
		TriggerClientEvent('esx:showNotification', _source, 'Opuszczasz strefę')
	else
		TriggerClientEvent('esx:showNotification', _source, 'Mozesz zbierac')
		PlayersHarvesting[_source]=true
	end
end)
...
AddEventHandler('esx_vigneronjob:startTransform', function(zone)
	...
	if PlayersTransforming[_source] == false then
		TriggerClientEvent('esx:showNotification', _source, '~r~To nie jest dobry błąd ~w~')
...
AddEventHandler('esx_vigneronjob:stopTransform', function()
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Możesz przekształcić swoje winogrona')
		PlayersTransforming[_source]=true
...
AddEventHandler('esx_vigneronjob:stopSell', function()
	...
	if PlayersSelling[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Możesz ~ sprzedać')
		PlayersSelling[_source]=true
	end
