    ...
    function(result)
      ...
      if foundNumber then
        ...
        if phoneNumber == xPlayer.get('phoneNumber') then
          TriggerClientEvent('esx:showNotification', _source, 'Nie możesz dodać siebie')
        else
          ...
          if hasAlreadyAdded then
            TriggerClientEvent('esx:showNotification', _source, 'Ten kontakt jest już w twoim katalogu')
          else
            ...
            MySQL.Async.execute(
              ...
              function(rowsChanged)
                ...
                TriggerClientEvent('esx:showNotification', _source, 'Dodano kontakt')
        ...
        TriggerClientEvent('esx:showNotification', source, 'Ta liczba nie istnieje')
      end
...
AddEventHandler('esx_phone:billCall', function(duration)
  ...
  TriggerClientEvent('esx:showNotification', _source, 'Twoje połączenie kosztowało: ~r~$' .. amount .. '~s~')
...
AddEventHandler('esx_phone:bankTransfer', function(target, amount)
  ...
  if amount > 0 and amount <= xPlayer.getAccount('bank').money then
    ...
    TriggerClientEvent('esx:showNotification', _source, 'Wystrzeliłeś ~g~$' .. amount .. '~s~ à ' .. targetXPlayer.name)

  else
    TriggerClientEvent('esx:showNotification', _source, 'Nieprawidłowa kwota')
  end
