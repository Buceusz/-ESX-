...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'sherif' then
    table.insert(elements, {label = _U('police_wear'), value = 'sergeant_wear'})
  end
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    table.insert(elements, { label = 'MustangGT', value = '2015POLSTANG'})
    table.insert(elements, { label = 'Ford', value = 'police3'})
    table.insert(elements, { label = 'Doge', value = 'police2'})
    table.insert(elements, { label = 'Motor', value = 'policeb'})
    table.insert(elements, { label = 'Bus Wiezienny', value = 'pbus'})
    table.insert(elements, { label = 'Bus Policyjny', value = 'policet'})
	table.insert(elements, { label = 'SWAT', value = 'riot'})
    table.insert(elements, { label = 'FBI', value = 'fbi'})
	table.insert(elements, { label = 'FBI SUV', value = 'fbi2'})
	table.insert(elements, { label = 'Victoria FBI ', value = 'police4'})
	table.insert(elements, { label = 'Porsche', value = 'pol718'})
	table.insert(elements, { label = 'MacLaren P1', value = 'polp1'})
